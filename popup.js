...
function popup1() {
    CreativaPopup.create('DM me if you need help for somethink jexx_12 &#10084', 'Discord');
}
...
function popup13() {
    CreativaPopup.create('DM me if you need help for somethink  <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">jexx_12</font> &#10084<br> <font style="color: #696969; font-size: smaller;">  <a href="discord.gg/enigmacheats</a> </font>', 'Discord', 'discord.gg/enigmacheats', {
        titleColor: '#6ffcff',
        textColor: '#b0b0b0'
    });
...
function allahm109kd() {
    navigator.clipboard.writeText("jexx_12");
    setTimeout(function() {
